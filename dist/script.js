...
const changeModalState = state => {
  const windowForm = document.querySelectorAll('.balcon_icons_img'),
    ...
    submitForm = document.querySelectorAll('.popup_calc_end'),
  ...
  bindActionToElems('click', submitForm, 'end');
};
...
const forms = state => {
  ...
  form.forEach(item => {
    const a = document.querySelector('.popup_calc_end');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const initTabs = function (headerSelector, tabSelector, contentSelector, activeClass) {
